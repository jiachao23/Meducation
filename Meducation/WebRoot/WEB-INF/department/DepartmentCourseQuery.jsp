...
<label>教师培训成绩查询</label>	
</div>		
       <fieldset id="fieldset-box">
			<legend>信息查询:</legend>
         <s:form name="form" id="form" action="TeacherEnrollment_getScoreTotle.action" method="post">
				<table id="newspaper-b">	
					<tr>
						<td class="buttom">培训计划:</td>
						<td class="buttom_right"><s:textfield id="planName" name="planName"
								cssClass="mytxt" placeholder="请输入培训计划" style="width:150px;" /></td>
					    <td class="buttom">培训机构名称:</td>
						<td class="buttom_right"><s:textfield id="agencyName" name="agencyName"
								cssClass="mytxt" placeholder="请输入培训机构名称" style="width:150px;" /></td>
						<td class="buttom">课程名称:</td>
						<td class="buttom_right"><s:textfield id="courseName" name="courseName"
								cssClass="mytxt" placeholder="请输入课程名称" style="width:150px;" /></td>
					    <td class="buttom">学校名称:</td>
						<td class="buttom_right"><s:textfield id="schoolName" name="schoolName"
								cssClass="mytxt" placeholder="请输入学校名称" style="width:150px;" /></td>					
					...
					<tr>
						<td class="buttom">课程开始时间（大于）:</td>
						<td class="buttom_right"><s:textfield id="courseBeginTime" name="courseBeginTime"
								cssClass="mytxt" placeholder="请输入课程开始时间" style="width:150px;" /></td>
						<td class="buttom">课程结束时间（小于）:</td>
						<td class="buttom_right"><s:textfield id="courseEndTime" name="courseEndTime"
								cssClass="mytxt" placeholder="请输入课程结束时间" style="width:150px;" /></td>
						<td class="buttom">教师姓名:</td>
						<td class="buttom_right"><s:textfield id="teacherRealName" name="teacherRealName"
								cssClass="mytxt" placeholder="请输入教师姓名" style="width:150px;" /></td>
						<td class="buttom">身份证号码:</td>
						<td class="buttom_right"><s:textfield id="teacherIdentifyNum" name="teacherIdentifyNum"
								cssClass="mytxt" placeholder="请输入身份证号码" style="width:200px;" /></td>						
					</tr>
				</table>
			</s:form>	
		</fieldset>	
			<div id="displayTable">
					<display:table name="pageList" id="table" export="true" requestURI="TeacherEnrollment_getScoreTotle.action"
