...
<label>培训机构课程信息查询</label>	
</div>		
       <fieldset id="fieldset-box">
			<legend>信息查询:</legend>
         <s:form name="form" id="form" action="AgencyCourse_recordQueryTotle.action" method="post">
				<table id="newspaper-b">	
					...
					<tr>
						...
						<td class="buttom_right"><s:textfield id="courseName" name="courseName"
								cssClass="mytxt" placeholder="请输入课程名称" style="width:300px;" /></td>
						<td class="buttom">课程学科类别:</td>
						<td class="buttom_right"><s:textfield id="courseSubject" name="courseSubject"
								cssClass="mytxt" placeholder="请输入课程学科类别" style="width:300px;" /></td>								
			...
			<div id="displayTable">
					<display:table name="pageList" id="table" export="true" requestURI="AgencyCourse_recordQueryTotle.action"
