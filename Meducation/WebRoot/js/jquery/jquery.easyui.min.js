...
},plugins:["draggable","droppable","resizable","pagination","_tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
(function($){
function init(_1dd){
$(_1dd).addClass("_tooltip-f");
};
function _1de(_1df){
var opts=$.data(_1df,"_tooltip").options;
$(_1df).unbind("._tooltip").bind(opts.showEvent+"._tooltip",function(e){
$(_1df)._tooltip("show",e);
}).bind(opts.hideEvent+"._tooltip",function(e){
$(_1df)._tooltip("hide",e);
}).bind("mousemove._tooltip",function(e){
if(opts.trackMouse){
opts.trackMouseX=e.pageX;
opts.trackMouseY=e.pageY;
$(_1df)._tooltip("reposition");
}
});
};
function _1e0(_1e1){
var _1e2=$.data(_1e1,"_tooltip");
if(_1e2.showTimer){
...
$(_1e4)._tooltip("arrow").css("left",tip._outerWidth()/2+pos.left);
pos.left=0;
}
}else{
...
$(_1e4)._tooltip("arrow").css("left",tip._outerWidth()/2-(pos.left-left));
}
}
}
}
...
tip.removeClass("_tooltip-top _tooltip-bottom _tooltip-left _tooltip-right").addClass("_tooltip-"+opts.position);
var left,top;
if(opts.trackMouse){
t=$();
...
var _1ea=$.data(_1e9,"_tooltip");
var opts=_1ea.options;
var tip=_1ea.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"_tooltip\">"+"<div class=\"_tooltip-content\"></div>"+"<div class=\"_tooltip-arrow-outer\"></div>"+"<div class=\"_tooltip-arrow\"></div>"+"</div>").appendTo("body");
_1ea.tip=tip;
_1eb(_1e9);
}
_1e0(_1e9);
_1ea.showTimer=setTimeout(function(){
$(_1e9)._tooltip("reposition");
tip.show();
opts.onShow.call(_1e9,e);
var _1ec=tip.children("._tooltip-arrow-outer");
var _1ed=tip.children("._tooltip-arrow");
...
_1f3.tip.children("._tooltip-content").html(cc);
opts.onUpdate.call(_1f1,cc);
};
function _1f4(_1f5){
var _1f6=$.data(_1f5,"_tooltip");
if(_1f6){
_1e0(_1f5);
...
$.removeData(_1f5,"_tooltip");
$(_1f5).unbind("._tooltip").removeClass("_tooltip-f");
opts.onDestroy.call(_1f5);
}
};
$.fn._tooltip=function(_1f7,_1f8){
if(typeof _1f7=="string"){
return $.fn._tooltip.methods[_1f7](this,_1f8);
}
_1f7=_1f7||{};
return this.each(function(){
var _1f9=$.data(this,"_tooltip");
if(_1f9){
$.extend(_1f9.options,_1f7);
}else{
$.data(this,"_tooltip",{options:$.extend({},$.fn._tooltip.defaults,$.fn._tooltip.parseOptions(this),_1f7)});
init(this);
}
_1de(this);
_1eb(this);
...
$.fn._tooltip.methods={options:function(jq){
return $.data(jq[0],"_tooltip").options;
},tip:function(jq){
return $.data(jq[0],"_tooltip").tip;
},arrow:function(jq){
return jq._tooltip("tip").children("._tooltip-arrow-outer,._tooltip-arrow");
},show:function(jq,e){
return jq.each(function(){
_1e8(this,e);
});
...
$.fn._tooltip.parseOptions=function(_1fb){
var t=$(_1fb);
...
$.fn._tooltip.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
t.find("._tooltip-f").each(function(){
...
$(_437)._tooltip($.extend({},opts.tipOptions,{content:_438.message,position:opts.tipPosition,deltaX:opts.deltaX}))._tooltip("show");
_438.tip=true;
};
function _42c(_439){
var _43a=$.data(_439,"validatebox");
if(_43a&&_43a.tip){
$(_439)._tooltip("reposition");
}
};
function _430(_43b){
...
$(this)._tooltip("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this)._tooltip("destroy");
